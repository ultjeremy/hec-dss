/*
 This project (hecdss) contains code for a shared object/dll, providing an API
 to work with DSS files.

 Only DSS version 7 files are supported.  DSS version 6 files should be
 converted to DSS version 7 using HEC-DSSVue
...
/// for example calling hec_dss_set_value("mlvl",10) sets the DSS output level
/// to 10
/// </summary>
...
/// for example calling hec_dss_set_string("PROG","DSSVue") sets the program
/// name
/// </summary>
/// <returns>zero on sucess</returns>
...
/// <param name="boolFullSet">set to 1 to return the dates of the entire dataset
/// (multiple records)</param>
/// <param name="firstValidJulian">output: Returns
/// the Julian date of the first valid value</param> <param
/// name="firstSeconds">output: Returns the time of day in seconds (for
/// firstJulian) of the first valid value</param> <param
/// name="lastValidJulian">output: Returns the Julian date of the last valid
/// value</param>
/// <param name="lastSeconds">output: Returns the time of day in
/// seconds of the last valid value</param> <returns></returns>
...
/// </summary>
/// <param name="intervalSeconds">interval in seconds , for example 3600 would
/// be used for 1Hour data</param>
/// <param name="julianStart">starting julian date</param>
/// <param name="startSeconds">staring seconds</param> <param
/// name="julianEnd">ending julian date</param>
/// <param name="endSeconds">ending seconds</param> <returns></returns>
...
/// <summary>
/// Gets size information about a time series record or data set (series of
/// records)
/// </summary>
/// <param name="dss">pointer to DSS file</param>
/// <param name="pathname">DSS pathname</param>
...
/// <param name="qualityElementSize">width of quality available for each
/// value</param> <returns></returns>
...
/// <param name="type">output: type of data: PER-AVER, PER-CUM,INST-VAL,INST-CUM
/// https://www.hec.usace.army.mil/confluence/dssvuedocs/latest/introduction/time-series-conventions</param>
/// <param name="typeLength">size of type buffer</param>
/// <returns></returns>
HECDSS_API int hec_dss_tsRetrieveInfo(dss_file *dss, const char *pathname,
...
/// <param name="pathBuffer">allocated buffer that is loaded with pathnames
/// </param>
/// <param name="recordTypes">output array of record types corresponding to each
/// path</param>
/// <param name="pathFilter">	Either null (for ignore) or a String that
/// represents a pathname with wild characters represented
///  by a star(*) to match any string in the pathname part.Wild characters can
///  only be at the beginning or end of a part, not inside of a string.An
///  example is a C part with "*Flow*", which will match all pathnames that have
///  "Flow" anywhere in the C part, such as "Flow", "Inflow", "Outflow-Reg",
///  etc. A part such as "Flow*Reg" is not supported. A null(//) will only match
///  a null, where only a star (*) will match all. </param>
/// <param name="count">number of paths that can be stored in pathBuffer, and
/// length of recordTypes array</param>
/// <param name="pathBufferItemSize">max allowable length of each
/// pathname</param> <returns>zero on success</returns>
...
/// A return value of zero or negative indicates an error finding the return
/// type
/// </summary>
...
/// <param name="timeArray">input/output: array to hold integer representation
/// of date-times</param>
...
/// https://www.hec.usace.army.mil/confluence/dssvuedocs/latest/introduction/time-series-conventions</param>
/// <param name="typeLength">size of type buffer</param>
/// <param name="timeZoneName">output: time zone name (for the time-series), can
/// be different from the location time-zone</param> <param
/// name="timeZoneNameLength">size of timeZoneName buffer</param>
/// <returns></returns>
...
/// https://www.hec.usace.army.mil/confluence/dssvuedocs/latest/introduction/time-series-conventions</param>
/// <param name="timeZoneName">time zone name (for the time-series), can be
/// different from the location time-zone</param>
/// <param name="storageFlag"> A flag indicating how to handle existing data on
/// disk:
///
/// For regular‐interval data:
///   0 – Always replace data.
///   1 – Only replace missing data.
///   2 – Write regardless, even if all data is missing (write a “missing”
///   record). 3 – If the record is entirely missing, do not write it and delete
///   any existing on‐disk copy. 4 – Do not allow missing input data to replace
///   valid data.
/// </param>
/// <returns>
/// True on success, false on failure.  // ← adjust to your actual return
/// semantics
/// </returns>
...
/// <param name="replace">set to 1 to overwrite existing data, otherwise use
/// 0</param> <returns></returns>
...
/// curves</param>
/// <param name="numberCurves">number of columns in the curve
...
/// <param name="isInterval"></param>
/// <param name="isTimeStamped"></param>
/// <param name="compressionSize">size of pre-compressed data (other wise set to
/// zero)</param>
/// <param name="dataUnits"></param>
/// <param name="dataSource"></param>
/// <param name="srsName"></param>
...
/// <returns>zero on sucess, HEC_DSS_BUFFER_TOO_SMALL if there was more text
/// than the bufferLength</returns>
